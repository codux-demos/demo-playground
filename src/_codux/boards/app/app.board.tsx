...
export default createBoard({
    ...
    Board: () => (
        <div className={App_board_module.root}>
            ...
            <span>
                Select {icon} Semantic to see how you can add external
                components
            </span>
        </div>
    ),
